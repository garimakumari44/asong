...
export default function Hero({value}) {
    ...
    return <div className="flex flex-col justify-center md:px-10 mx-2 lg:px-40 lg:mt-10 ">
        ...
        <p ref={element} className="text-6xl text-purple-800 mt-50  font-bold"> {
            ...
            <motion.p initial={{opacity: 0, y:50}} animate={{opacity: 1, y:0 }} transition={{duration: 2, staggerChildren: 0.5}} className="text-2xl text-purple-300 py-14 px-10 text-center ">These lyrics are breathtaking, They stir something deep within, like a whisper from the soul. Let your inner world unfold through the words that resonate with you most—those lines that feel like they were written just for you. Lose yourself in the melody of your favorite lyrics, and let them guide you to places only your heart knows.. </motion.p>
