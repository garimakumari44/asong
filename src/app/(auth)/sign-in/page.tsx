...
function SignIn() {
  return (
    <div className="w-full bg-gradient-to-r h-screen from-indigo-100 via-purple-100 to-pink-100 " >
      ...
      <div className='justify-center font-bold text-center'> Don't you have an account?  <Link href='/sign-up'> <span className='text-lg font-bold text-purple-800'> Signup</span> </Link></div>
