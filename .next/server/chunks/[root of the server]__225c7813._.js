...
"[project]/.next-internal/server/app/api/ai/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
async function POST(req) {
    try {
        ...
        const chat = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$chat$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Chat"].findOne({
            _id: chatId
        });
        if (!chat) {
        ...
        await chat.save();
        // Get AI response
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].post("https://openrouter.ai/api/v1/chat/completions", {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__225c7813._.js.map